...
class ViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    @IBAction func scorecardButton(_ sender: UIButton) {
        ...
        if user.highScore == nil{
            ...
            myVC.stringPassed = user.highScore!
        }
    ...
    @IBAction func addPointsButton(_ sender: UIButton) {
        if rolls == 3{
            ...
            if choices.contains(selectedRow) && selectedRow != 11{
                ...
                if totalPoints > Int(user.highScore!)!{
                    user.highScore=String(totalPoints)
                }
    ...
    override func viewDidLoad() {
        ...
        if FileManager.default.fileExists(atPath: filePath!){
            ...
            //load high score
            if dataDictionary.keys.contains("score") {
                user.highScore = dataDictionary["score"]
            }
        }
    ...
    func applicationWillResignActive(_ notification: Notification){
        ...
        //adds
        if user.highScore != nil{
            data.setValue(user.highScore, forKey: "score")
        }
